...
void FSWebCam::setCamera(const QByteArray &cameraDevice)
{
    ...
    camera->setViewfinder(PolyFabScanWindow::getInstance()->ui->webcamView );

    PolyFabScanWindow::getInstance();//->ui->cameraLabel->setStyleSheet("border-style: solid; border-color: black; border-width: 3px 1px 3px 1px;");
    PolyFabScanWindow::getInstance()->ui->cameraLabel->setText("");
